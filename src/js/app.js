App = {
     ...
     displayZombie: function (id, name, dna, level, readyTime, winCount, lossCount,zombieId) {
          ...
          zombieTemplate.find('.zombie-zombieId').text(zombieId);
     ...
     randomHex: function (unit256 dna) {
          let Hexcolor = dna},

     invertHex: function (Hexcolor){
          let complementaryHexcolor= 1/Hexcolor
     },
